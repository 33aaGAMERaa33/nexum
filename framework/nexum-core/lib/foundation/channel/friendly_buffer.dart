...
class FriendlyBuffer {
  ...
  void write(String identifier, Object object) {
    _data1 += "$identifier=${_escape(object.toString())};";
    _data2 += "1=${_escape(object.toString())};";
    _content.add(_Data(identifier, object.toString()));

    print("${_data1.length} -> ${_data2.length}");
  }
  ...
  String getData() => _data1;

  List<int> buildBuffer() => utf8.encode(getData());
